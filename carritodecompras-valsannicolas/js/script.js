...
document.addEventListener("DOMContentLoaded", () => {
 ...
 document.getElementById("testimonial-prev").addEventListener("click", () => setSlide(currentSlide - 1));
 document.getElementById("testimonial-next").addEventListener("click", () => setSlide(currentSlide + 1));
